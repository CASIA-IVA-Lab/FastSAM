...
def parse_args():
    ...
    parser.add_argument('--point_label', type=str, default="[0]", help='point label mask is 1 and background is 0')
    ...
    parser.add_argument('--retina', type=bool, default=True, help='use retina mask high quality')
